...
Micro navigation combines various UI patterns within a main container, providing a consistent and seamless navigation experience across Unit4 products. It creates an L-shaped layout that optimizes screen real estate while maintaining persistent access to navigation and workspace management tools.

> **Note:** Micro navigation patterns are compatible with devices up to tablet sizes. For mobile devices, alternative navigation patterns should be used.
