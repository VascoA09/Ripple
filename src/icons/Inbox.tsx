...
/**
 * Inbox icon.
 * Source: Font Awesome Pro 6, Regular style ("inbox").
 */
export const Inbox = React.forwardRef<SVGSVGElement, IconProps>(
  function Inbox({ size = 24, color = 'currentColor', ...rest }, ref) {
    return (
      <svg
        ref={ref}
