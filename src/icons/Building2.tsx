...
/**
 * Building2 icon.
 * Source: Font Awesome Pro 6, Regular style ("building").
 */
export const Building2 = React.forwardRef<SVGSVGElement, IconProps>(
  function Building2({ size = 24, color = 'currentColor', ...rest }, ref) {
    return (
      <svg
        ref={ref}
