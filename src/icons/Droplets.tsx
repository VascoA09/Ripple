...
/**
 * Droplets icon.
 * Source: Font Awesome Pro 6, Regular style ("droplet").
 */
export const Droplets = React.forwardRef<SVGSVGElement, IconProps>(
  function Droplets({ size = 24, color = 'currentColor', ...rest }, ref) {
    return (
      <svg
        ref={ref}
