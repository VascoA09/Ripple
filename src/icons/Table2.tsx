...
/**
 * Table2 icon.
 * Source: Font Awesome Pro 6, Regular style ("table").
 */
export const Table2 = React.forwardRef<SVGSVGElement, IconProps>(
  function Table2({ size = 24, color = 'currentColor', ...rest }, ref) {
    return (
      <svg
        ref={ref}
