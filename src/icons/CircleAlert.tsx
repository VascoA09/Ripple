...
/**
 * CircleAlert icon.
 * Source: Font Awesome Pro 6, Regular style ("circle-exclamation").
 */
export const CircleAlert = React.forwardRef<SVGSVGElement, IconProps>(
  function CircleAlert({ size = 24, color = 'currentColor', ...rest }, ref) {
    return (
      <svg
        ref={ref}
