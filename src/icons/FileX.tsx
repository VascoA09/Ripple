...
/**
 * FileX icon.
 * Source: Font Awesome Pro 6, Regular style ("file-slash").
 */
export const FileX = React.forwardRef<SVGSVGElement, IconProps>(
  function FileX({ size = 24, color = 'currentColor', ...rest }, ref) {
    return (
      <svg
        ref={ref}
