...
/**
 * Palette icon.
 * Source: Font Awesome Pro 6, Regular style ("palette").
 */
export const Palette = React.forwardRef<SVGSVGElement, IconProps>(
  function Palette({ size = 24, color = 'currentColor', ...rest }, ref) {
    return (
      <svg
        ref={ref}
