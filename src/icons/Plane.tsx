...
/**
 * Plane icon.
 * Source: Font Awesome Pro 6, Regular style ("plane").
 */
export const Plane = React.forwardRef<SVGSVGElement, IconProps>(
  function Plane({ size = 24, color = 'currentColor', ...rest }, ref) {
    return (
      <svg
        ref={ref}
