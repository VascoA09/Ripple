...
/**
 * Hotel icon.
 * Source: Font Awesome Pro 6, Regular style ("hotel").
 */
export const Hotel = React.forwardRef<SVGSVGElement, IconProps>(
  function Hotel({ size = 24, color = 'currentColor', ...rest }, ref) {
    return (
      <svg
        ref={ref}
