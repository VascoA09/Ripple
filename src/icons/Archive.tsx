...
/**
 * Archive icon.
 * Source: Font Awesome Pro 6, Regular style ("box-archive").
 */
export const Archive = React.forwardRef<SVGSVGElement, IconProps>(
  function Archive({ size = 24, color = 'currentColor', ...rest }, ref) {
    return (
      <svg
        ref={ref}
