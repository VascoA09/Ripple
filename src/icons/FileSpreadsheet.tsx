 ...
 * Source: Font Awesome Pro 6, Regular style ("file-spreadsheet").
 */
export const FileSpreadsheet = React.forwardRef<SVGSVGElement, IconProps>(
  function FileSpreadsheet({ size = 24, color = 'currentColor', ...rest }, ref) {
    return (
      <svg
        ref={ref}
